        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocIcon = table.Column<string>(maxLength: 100, nullable: false),
                    PhonIcon = table.Column<string>(maxLength: 100, nullable: false),
                    AdressIcon = table.Column<string>(maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
